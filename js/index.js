$(function() {
	...
	var widthDIV3 = widthDIV * (liLen + 1);
	
	for (var i = 0; i < lis.length ; i++){
		lis[i].setAttribute('index',i+1);
		
	}
	$(".banner ul").css('width', widthDIV3);
	$(".banner ul li").css({ 'width': widthDIV,});
	
	//$(window).resize(function() { 
//		widthDIV = $(document).width();
//		widthDIV3 = widthDIV * (liLen + 1);
//		$(".banner ul").css('width', widthDIV3);
//		$(".banner ul li").css({ 'width': widthDIV,});
//		//timerFn();
//	}); 
	...
	var timerFn = function() {
		...
		var moveLeft = -widthDIV * loopIndex;
	...
	$(".banner ol li").click(function() {
		...
		var moveLeft = -widthDIV * $(this).index();
		$(".banner ul").stop().animate({
			"left": "" + moveLeft + "px"
		}, 500);
